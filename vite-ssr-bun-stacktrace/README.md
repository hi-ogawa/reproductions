...
```sh
$ deno task repro
Task repro deno run -A --node-modules-dir repro.mjs
Error: boom
    at throwError2 (/xxx/repro-entry.ts:10:9)
    at throwError (/xxx/repro-entry.ts:6:3)
    at main (/xxx/repro-entry.ts:15:5)
    at /xxx/repro-entry.ts:21:1
    at ESModulesEvaluator.runInlinedModule (/xxx/node_modules/.deno/vite@6.0.0-beta.2/node_modules/vite/dist/node/module-runner.js:1065:6)
    at ModuleRunner.directRequest (/xxx/node_modules/.deno/vite@6.0.0-beta.2/node_modules/vite/dist/node/module-runner.js:1037:82)
    at ModuleRunner.cachedRequest (/xxx/node_modules/.deno/vite@6.0.0-beta.2/node_modules/vite/dist/node/module-runner.js:935:28)
    at ModuleRunner.import (/xxx/node_modules/.deno/vite@6.0.0-beta.2/node_modules/vite/dist/node/module-runner.js:873:23)
    at /xxx/repro.mjs:19:1
```
