...
!!!!! transformRequest("/dir2/file.js", { ssr: true })
{
  ...
  map: SourceMap {
    ...
    names: [],
    mappings: ';AAAqC;AACrC,OAAO,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CAAC,EAAE,CAAC,CAAC,CAAC,qBAAG,CAAC,CAAC,CAAC,CAAC;AACvC;AACA,CAAC,CAAC,CAAC,MAAM,CAAC,CAAC,CAAC,EAAE,CAAC,IAAI,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CAAC,EAAE,CAAC;AAC1C,CAAC,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CAAC,EAAE,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC;'
  },
  deps: [ './dir1/file.js' ],
  dynamicDeps: []
}
...
Error: Failed to resolve import "./dir1/file.js" from "dir2/file.js". Does the file exist?
    ...
    at async file:///home/hiroshi/code/personal/reproductions/vitest-5261-wrong-relative/main.js:10:13 {
